...
parser.add_argument("--precision", type=str, help="evaluate at this precision", choices=["fp16dual","fp16", "int4", "int8", "cpu"], default="fp16")
parser.add_argument("--listen", action='store_true', help="launch gradio with 0.0.0.0 as server name, allowing to respond to network requests")
parser.add_argument("--cpu", action='store_true', help="use cpu")
parser.add_argument("--share", action='store_true', help="use gradio share")
parser.add_argument("--availablecard", type=str, default="1,")
